...
#define ButtonStop_Pin GPIO_PIN_9
#define ButtonStop_GPIO_Port GPIOD
#define ButtonStop_EXTI_IRQn EXTI9_5_IRQn
#define ButtonOsmos_Pin GPIO_PIN_10
#define ButtonOsmos_GPIO_Port GPIOD
#define ButtonOsmos_EXTI_IRQn EXTI15_10_IRQn
